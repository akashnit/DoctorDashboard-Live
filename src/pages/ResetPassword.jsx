...
const ResetPassword = () => {
  ...
  useEffect(() => {
    // Validate token (this is just a basic check, your backend should validate it properly)
    if (!token) {
      setTokenValid(false);
      setMessage({
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setMessage({
        text: error.message || "Failed to reset password. Please try again or request a new reset link.",
        type: "error"
      });
    } finally {
      setLoading(false);
            ...
            <div className="space-y-6">
              ...
              <div className="text-center">
                ...
                <p className="mt-2 text-sm text-gray-600">
                  Need a new reset link? Click "Forgot password?" on the login page.
                </p>
              </div>
            </div>
          )}
